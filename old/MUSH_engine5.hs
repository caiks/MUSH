...
main = 
  do
    ...
    printf "NIST_train size: %d\n" $ historyRepasSize hh
    hFlush stdout

    let model = "MUSH_model5a"
    let (wmax,lmax,xmax,omax,bmax,mmax,umax,pmax,fmax,mult,seed) = ((9*9*10), 8, (9*9*10), 10, (10*3), 3, (9*9*10), 1, 30, 1, 1)

    printf ">>> %s\n" $ model
    Just (uu',df) <- decomperIO uu vv hh wmax lmax xmax omax bmax mmax umax pmax fmax mult seed
    ByteString.writeFile (model ++ ".json") $ decompFudsPersistentsEncode $ decompFudsPersistent df
    printf "<<< done %s\n" $ model
    hFlush stdout
    ...
    let model = "MUSH_model5b"
    let (wmax,lmax,xmax,omax,bmax,mmax,umax,pmax,fmax,mult,seed) = ((9*9*10), 8, (9*9*10), 10, (10*3), 3, (9*9*10), 1, 30, 1, 98765)
    ...
    let model = "MUSH_model5c"
    let (wmax,lmax,xmax,omax,bmax,mmax,umax,pmax,fmax,mult,seed) = ((9*9*10), 8, (9*9*10), 10, (10*3), 3, (9*9*10), 1, 30, 3, 1)
    ...
    let (wmax,lmax,xmax,omax,bmax,mmax,umax,pmax,fmax,mult,seed) = ((9*9*10), 8, (9*9*10), 10, (10*3), 4, (9*9*10), 1, 30, 1, 1)
    ...
    let model = "MUSH_model5e"
    let (wmax,lmax,xmax,omax,bmax,mmax,umax,pmax,fmax,mult,seed) = ((9*9*10), 8, (9*9*10), 10, (10*3), 2, (9*9*10), 1, 30, 1, 1)
    ...
    let model = "MUSH_model5f"
    let (wmax,lmax,xmax,omax,bmax,mmax,umax,pmax,fmax,mult,seed) = ((9*9*10), 8, (9*9*10), 10, (10*3), 3, (9*9*10), 1, 30, 3, 123456)
    ...
    let model = "MUSH_model5g"
    let (wmax,lmax,xmax,omax,bmax,mmax,umax,pmax,fmax,mult,seed) = ((9*9*10), 8, (9*9*10), 10, (10*3), 3, (9*9*10), 1, 30, 6, 123456)
